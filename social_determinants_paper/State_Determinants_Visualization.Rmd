...
#tempb4 <- nrow(GWAS_MRR) # check the number of rows before extracting non_rate variables
#tempb4
#namesb4 <-rownames(GWAS_MRR)
#namesb4

GWAS_MRR <- GWAS_MRR[ !(row.names(GWAS_MRR) %in% non_rate), ]

#tempAFTR <- nrow(GWAS_MRR) # check that rows have been removed
#tempAFTR
#namesAFTR <- rownames(GWAS_MRR)
#namesAFTR
```
